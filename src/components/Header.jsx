  ...
  return (
    <>
      <main className="sticky top-0 left-0 bg-white shadow-md">
        <header className="flex space-x-10 w-[1100px] mx-auto items-center py-[14px]">
          <div>
            <img
              className="w-[114px]"
          ...
          <div className="flex items-center px-3 py-[6px] bg-gray-100 border-2 border-gray-300 rounded-2xl">
            <BsSearch />
            <input
              className="ml-1 px-[6px] py-[2px] w-[270px] bg-gray-100 placeholder:text-gray-500 font-semibold"
              type="text"
              placeholder="Search Stocks, Mutual Funds, etc"
            />
          </div>
          <div className="space-x-8 text-[15px] font-semibold text-gray-700">
            <span>Explore</span>
            <span>Features</span>
            <span>Pricing</span>
            <span>Blog</span>
